...
\begin{document}
    ...
    \begin{multicols}{2}
        ...
        \input{src/graph/o1lca_st_dfn.tex}
        ...
        \subsection{笛卡尔树}
        \inputminted{cpp}{src/graph/笛卡尔树.cpp}
        \subsection{2-SAT}
        ...
        % 原始对偶费用流？
        \subsection{KM最小权完美匹配}
        \inputminted{cpp}{src/graph/KM.cpp}
        \subsection{树哈希}
        \inputminted{cpp}{src/graph/tree_hash.cpp}
        \subsection{差分约束}
        ...
        \section{数据结构}
        \subsection{线段树二分}
        \inputminted{cpp}{src/data structure/seg_binary_search.cpp}
        \subsection{平衡树}
        ...
        \section{多项式}
        \subsection{O(nV)多重背包（单调队列优化）}
        \inputminted{cpp}{src/poly/multi-packs.cpp}
        \subsection{二项式反演}
        \input{src/poly/exsfy.tex}
        \subsection{FFT}
        \inputminted{cpp}{src/poly/fft.cpp}
        \subsection{NTT}
        \inputminted{cpp}{src/poly/ntt.cpp}
        \subsection{拉格朗日插值}
        \input{src/poly/lagrange.tex}
        \subsection{集合幂级数}
        ...
        \section{数论}
        \subsection{exgcd}
        \inputminted{cpp}{src/number theory/exgcd.cpp}
        \subsection{类欧几里得}
